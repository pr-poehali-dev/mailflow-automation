...
const SEO_BY_PAGE: Record<Page, SeoMeta> = {
  ...
  partners: {
    title: "Партнёрская программа MAIL-KA — заработай до 40% с клиента",
    description: "Реферальная программа, партнёрство для агентств, White Label и технологические интеграции. До 40% дохода с каждого приведённого клиента, выплаты ежемесячно, минимум 1 000 ₽.",
    keywords: "партнёрская программа, реферальная программа, white label email, заработок на рекомендациях, партнёрство для агентств",
  },
};
